...
- [this Wiki](https://github.com/Xon77/Live4Life/wiki) for e.g. notes on [spatialization techniques](https://github.com/Xon77/Live4Life/wiki/Spatial-objectives) or [some personal thoughts](https://github.com/Xon77/Live4Life/wiki/Personal-context-and-questions),
...
- **[Live 4 Bubbles](https://github.com/Xon77/Live4Bubbles)** (based on Tidal Cycles, Haskell and SuperCollider), a kind of **DJing with code and pattern parameters**,
- and **[Fizzy Hydra](https://github.com/Xon77/FizzyHydra)** (a visual sequencer based on Hydra and javascript).
